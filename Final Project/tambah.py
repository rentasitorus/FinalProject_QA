...
class TestTambah(unittest.TestCase):  # TEST SCENARIO
    ...
    def test_a_success_add_user(self): 
        ...
        time.sleep(1)
        browser.find_element(By.XPATH,'//*[@id="app"]/div[1]/div[2]/div[2]/div/div[2]/div[1]/button').click() # klik fitur admin
        time.sleep(1)
    ...
    def test_b_success_add_employee(self): 
        # steps
        browser = self.browser #buka web browser
        browser.get("https://opensource-demo.orangehrmlive.com/web/index.php/auth/login") # buka situs
        time.sleep(3)
    ...
    def test_b_success_add_candidates(self): 
        # steps
        browser = self.browser #buka web browser
        browser.get("https://opensource-demo.orangehrmlive.com/web/index.php/auth/login") # buka situs
        time.sleep(3)
    ...
    def test_b_success_add_candidates_empty_vacancies(self): 
        # steps
        browser = self.browser #buka web browser
        browser.get("https://opensource-demo.orangehrmlive.com/web/index.php/auth/login") # buka situs
        time.sleep(3)
